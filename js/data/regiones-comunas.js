/**
 * INFORCORE - Datos de regiones y comunas de Chile
 * Fuente: division politico-administrativa vigente (16 regiones, 346 comunas).
 *
 * Uso: incluir este archivo ANTES del script que arma los select encadenados.
 *   <script src="js/data/regiones-comunas.js"></script>
 *
 * Estructura:
 *   REGIONES = [ { id, nombre, comunas: [ "Comuna", ... ] }, ... ]
 */
...
const REGIONES = [
  ...
  },
  {
    ...
    comunas: [
      ...
      "Colina", "Lampa", "Tiltil", "San Bernardo", "Buin",
  ...
  },
  {
    ...
    comunas: [
      ...
      "Pinto", "Quillón", "San Ignacio", "Yungay", "Quirihue",
      "Cobquecura", "Coelemu", "Ninhue", "Portezuelo", "Ránquil",
      "Treguaco", "San Carlos", "Coihueco", "Ñiquén", "San Fabián",
      "San Nicolás"
    ]
  },
  {
